...
With these knowledge, we can verify the correctness of the implementation of a sine function even if we don't know a value the value _sin(x)_ should return for a given _x__.
